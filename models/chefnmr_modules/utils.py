# Start from code from https://github.com/jwohlwend/boltz/blob/cb04aeccdd480fd4db707f0bbafde538397fa2ac/src/boltz/model/modules/utils.py 
...
def smooth_lddt_loss(
    ...
    # Uses sigmoid for smooth gradients (from alphafold3-pytorch implementation)
    # Note: This makes perfect predictions give LDDT score ~0.8 instead of 1.0,
    # resulting in a loss floor of ~0.2. This is intentional for gradient smoothness.
    eps = (
        (
            (
